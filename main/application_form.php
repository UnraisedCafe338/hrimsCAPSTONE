...
<td colspan="2">
  ...
  >
            ...
            <div id="page7" class="page">
                <h3>📎 Upload Required Documents - Final Step!</h3>
                <p style="text-align: center; font-size: 16px; color: #666; margin-bottom: 30px;">
                    Please upload the required documents to complete your application. Multiple files are supported for each category.
                </p>

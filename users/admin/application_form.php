...
<body>
    ...
    <form action="../../handlers/admin/process_application.php" method="POST" id="empform" enctype="multipart/form-data">
...
<script>
    ...
    fetch('../../handlers/admin/autosave.php', {
            method: 'POST',
            headers: {
...
function handleSubmitClick() {
    ...
    fetch('../../handlers/admin/get_jobs.php')
        .then(res => res.json())
        .then(data => {

<?php
// Check Sample Employee Data in Employees Collection
// This script checks only our sample employee data in the employees collection
...
try {
    ...
    // Find only our sample employees (those with @company.com emails)

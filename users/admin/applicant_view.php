  ...
  <div class="content">
    ...
    <div class="container">
      <div class="profile">
        ...
        ?>
        <?php if ($photoId): ?>
          <img src="../../handlers/admin/get_image.php?id=<?php echo $photoId; ?>" alt="Applicant Photo" />
        <?php else: ?>
            ...
            <?php if (!empty($documents[$inputName])): ?>
              <div class="documents-grid">
                <?php foreach ($documents[$inputName] as $fileId):
                  ...
                  $downloadUrl = "../../handlers/admin/download_file.php?id=" . urlencode($fileId);
...
document.getElementById("save-btn").addEventListener("click", function () {
  ...
  fetch("../../handlers/admin/update_application.php?id=<?php echo $id; ?>", {
    method: "POST",
    body: formData
  })

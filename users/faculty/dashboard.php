...
$position = $user['position'] ?? 'Faculty Member';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Faculty Dashboard | HRIMS</title>
    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="dashboard-header">
                ...
                <p>Manage your academic responsibilities</p>
            </div>
            ...
            <div class="evaluation-section">
                <div class="section-header">
                    ...
                    <p>Your teaching and research metrics</p>
                </div>
            ...
            <div class="evaluation-section">
                ...
                <div class="info-card">
                    ...
                    <p><strong>Email:</strong> <?php echo htmlspecialchars($username); ?></p>
                ...
                <div class="info-card">
                    ...
                    <p><strong>Teaching Load:</strong> Not assigned</p>
                    <p><strong>Research Areas:</strong> Not specified</p>
                    <p><strong>Office Hours:</strong> Not set</p>
                </div>
            </div>
        </div>
    </div>
